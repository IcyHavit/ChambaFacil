...
export default function Cliente() {
  ...
  return (
    <Box sx={{ borderColor: theme.palette.primary.main, borderStyle: 'solid', width: '55rem', borderRadius: theme.shape.borderRadius }}>
      ...
      <Box component='form' onSubmit={handleSubmit} sx={{ p: 3, display: 'flex', flexDirection: 'column', gap: 2, boxShadow: 3, borderRadius: 2 }}>
